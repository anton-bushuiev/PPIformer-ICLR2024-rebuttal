...
from ppiformer.definitions import TRAINING_SUBMISSION_DIR
...
def main(cfg : DictConfig) -> None:
    ...
    # TODO Implement a method for subclasses to define what to pass and what to preserve
